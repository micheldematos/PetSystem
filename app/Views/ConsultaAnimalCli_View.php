                    ...
                    <div class="col-md-12 d-flexx justify-content-between align-items-center" >
                        <div class="row d-flex align-items-center">
                          ...
                          <div class="col">
                            ...
                            <div class="col" style="padding: 0;">
                                <button type="button" class="btn btn-danger d-flex align-items-center btConCad" style="width: 168px; font-weight: bold; height: 40px;background-color: #DF322E; font-size: 12px; width: 112px; margin-left: 12px;"><a href="/PetSystem/public/cadA" class="fonte-titulo-claro" style="text-decoration: none;" >CADASTRAR ANIMAL</a> </button>
                            </div>
                        ...
                        <div class="col" style="margin-top: 16px;">
                            <a href="/PetSystem/public/AltAnimal/<?php echo $valor->CodAnimal?>" class="fonte-titulo" style="text-decoration: none;"><h2 class="text-break" style="text-decoration: none; font-weight: bolder; margin: 0;">Nome: <?php echo $valor->Nome?></h2></a>
...
foreach ($ConAnimais->getResult() as $valor) {
  ...
  echo "<br>";
  echo "<a href='/PetSystem/public/IntAnimal/$valor->CodAnimal'>Inativar</a>";
  echo " / ";
  echo "<a href='/PetSystem/public/AtivAnimal/$valor->CodAnimal'>Ativar</a>";
  echo "<br>";
  echo "<br>";
}
?> -->