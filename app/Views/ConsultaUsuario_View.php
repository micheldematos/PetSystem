                    ...
                    <div class="col-md-12 d-flexx justify-content-between align-items-center" >
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control fonte-titulo" id="formGroupExampleInput" placeholder="Pesquisar" style="margin-right: 16px; min-width: 256px;" name="NomeUsuario">
                            </div>
                            ...
                            <div class="col" style="padding: 0;">
                                <button type="button" class="btn btn-danger d-flex align-items-center btConCad" style="width: 168px; font-weight: bold; height: 40px;background-color: #DF322E; font-size: 12px; width: 112px; margin-left: 12px;"><a href="/PetSystem/public/cadU" class="fonte-titulo-claro" style="text-decoration: none;" >CADASTRAR USUÁRIO</a> </button>
                            </div>

                        </div>

                        <?php use App\Models\SelectOptions; $so = new SelectOptions(); foreach ($ConUsuario->getResult() as $valor) {?>

                        <div class="col" style="margin-top: 16px;">
                            <a href="/PetSystem/public/AltUsuario/<?php echo $valor->CodUsuario?>" class="fonte-titulo" style="text-decoration: none;"><h2 class="text-break" style="text-decoration: none; font-weight: bolder; margin: 0;">Nome: <?php echo $valor->Nome?></h2></a>
                            <p class="" style="color: #E34C48;">Código: <?php echo $valor->CodUsuario?></p>
                        </div>
        ...
        <div class="container" style="padding-top: 2vh; margin-left: 3vh;">
            ...
            $so = new SelectOptions();
             foreach ($ConUsuario->getResult() as $valor) {
                 ...
                 echo "<br>";
                 echo "<a href='/PetSystem/public/AltUsuario/$valor->CodUsuario'>Alterar</a>";
                 echo "<br>";
                 echo "<br>";
             }
             ...
             foreach ($ConUsuario->getResult() as $valor) {
                ...
                echo "<a href='/PetSystem/public/IntUsuario/$valor->CodUsuario'>Inativar</a>";

                echo " / ";

                echo "<a href='/PetSystem/public/AtivUsuario/$valor->CodUsuario'>Ativar</a>";
