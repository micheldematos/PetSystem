                ...
                <div class="row d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-12 d-flexx justify-content-between align-items-center" >
                        ...
                        <div class="col" style="margin-top: 16px;">
                            <a href="/PetSystem/public/AltTipoServico/<?php echo $valor->CodTipoServ?>" class="fonte-titulo" style="text-decoration: none;"><h2 class="text-break" style="text-decoration: none; font-weight: bolder; margin: 0;">Nome: <?php echo $valor->NomeServico?></h2></a>
        ...
        <div class="container" style="padding-top: 2vh; margin-left: 3vh;">
            ...
            $so = new SelectOptions();
             foreach ($ConTipoServico->getResult() as $valor) {
                 ...
                 echo "<br>";
                 echo "<a href='/PetSystem/public/AltTipoServico/$valor->CodTipoServ'>Alterar</a>";
                 echo "<br>";
                 echo "<br>";
             }
            ?>
