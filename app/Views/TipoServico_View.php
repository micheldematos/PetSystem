  ...
  <div class="collapse navbar-collapse" id="navbarNav" style="font-size: 16px;">
    <div>
      ...
      <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item" href='/ProjetoWeb/public/#'> Usuário</a></li>
      </ul>
      </li>
      ...
      <div class="d-flex justify-content-between">
        ...
        <div class="container d-flex justify-content-center">
          <div class="row col-md-6 d-flex justify-content-between align-items-center campos_cad_cli">
            <h2 class="fonte-titulo text-break" style="font-size: 32px; font-weight: bold; margin: 0; padding: 0;">Cadastro de serviço</h2><br>
            
            
            <div class="col-md-12">
                <form action="" method="post">
                <label for="formGroupExampleInput2" class="form-label"><strong class="fonte-titulo">Nome</strong></label>
                <input type="text" class="form-control fonte-titulo" name="NomeServico" id="formGroupExampleInput2" placeholder="Nome do serviço">
            </div>

            <div class="col-md-12">
              <label for="formGroupExampleInput2" class="form-label"><strong class="fonte-titulo">Preço</strong></label>
              <input type="text" class="form-control fonte-titulo" name="Preco" id="formGroupExampleInput2" placeholder="Preço">
            </div>
