                    ...
                    <div class="col-md-12 d-flexx justify-content-between align-items-center" >
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control fonte-titulo" id="formGroupExampleInput" placeholder="Nome do serviço" style="margin-right: 16px; min-width: 256px;" name="Nome">
                            </div>
                          ...
                          <div class="col" style="padding: 0;">
                                <button type="button" class="btn btn-danger d-flex align-items-center btConCad" style="width: 168px; font-weight: bold; height: 40px;background-color: #DF322E; font-size: 12px; width: 112px; margin-left: 12px;"><a href="/ProjetoWeb/public/cadServico" class="fonte-titulo-claro" style="text-decoration: none;" >CADASTRAR SERVIÇO</a> </button>
                            </div>

                        </div>

                        <?php use App\Models\SelectOptions; $so = new SelectOptions(); foreach ($ConServico->getResult() as $valor) {?>

                        <div class="col" style="margin-top: 16px;">
                            <a href="" class="fonte-titulo" style="text-decoration: none;"><h2 class="text-break" style="text-decoration: none; font-weight: bolder; margin: 0;">Nome: <?php echo $so->selectTipoServico($valor->CodTipoServ)?></h2></a>
                            <p class="" style="color: #E34C48;">Código: <?php echo $valor->CodServico?></p>
                        </div>

                        <?php }?>

                        <div class="col" style="margin-top: 16px;">
                            <a href="" class="fonte-titulo" style="text-decoration: none;"><h2 class="text-break" style="text-decoration: none; font-weight: bolder; margin: 0;">Nome do serviço</h2></a>
                            <p class="" style="color: #E34C48;">Código</p>
                        </div>
