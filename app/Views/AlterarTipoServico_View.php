      ...
      <div class="d-flex justify-content-between">
        ...
        <div class="container d-flex justify-content-center">
          <div class="row col-md-6 d-flex justify-content-between align-items-center campos_cad_cli">
            <h2 class="fonte-titulo text-break" style="font-size: 32px; font-weight: bold; margin: 0; padding: 0;"><?php echo$valor->NomeServico?> <a href="/ProjetoWeb/public/removeTipoServico/<?php echo $valor->CodTipoServ ?>"><img src="<?php echo base_url("/IMAGENS/lixeira.svg") ?>" alt=""></a></h2><br>
