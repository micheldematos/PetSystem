      ...
      <div class="d-flex justify-content-between">
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-start align-items-center" style="margin-top: 36px; margin-bottom: 36px; padding: 0;">
              ...
              <button type="button" class="botaoLogin btn btn-outline-light" style="font-weight: bolder; margin-right: 10px; margin-left: 10PX; border-color: #DF322E; color: #DF322E;"><a href='/PetSystem/public/IntAnimal/<?php echo $valor->CodAnimal ?>' style="text-decoration: none; color: #DF322E;">INATIVAR</a></button>

              <?php }else{?>
                <button type="button" class="botaoLogin btn btn-outline-light" style="font-weight: bolder; margin-right: 10px; margin-left: 10PX; border-color: #DF322E; color: #DF322E;"><a href='/PetSystem/public/AtvAnimal/<?php echo $valor->CodAnimal ?>' style="text-decoration: none; color: #DF322E;">ATIVAR</a></button>
                <?php } ?>
              </form>
            </div>
