      ...
      <div class="d-flex justify-content-between">
        ...
        <div class="container d-flex justify-content-center">
          <div class="row col-md-6 d-flex justify-content-between align-items-center campos_cad_cli">
            <h2 class="fonte-titulo text-break" style="font-size: 32px; font-weight: bold; margin: 0; padding: 0;">Nome do animal</h2><br>
            ...
            <div class="col-md-12">
                ...
                <input type="text" name="Nome" class="form-control fonte-titulo" id="formGroupExampleInput2" placeholder="Animal">
            </div>

            <!-- Ajustar -->
            <div class="col-md-6">
              <label for="formGroupExampleInput2" class="form-label"><strong class="fonte-titulo">Data da adoção</strong></label>
              <input type="text" name="Data_Adocao" class="form-control fonte-titulo" id="formGroupExampleInput2" placeholder="xx/xx/xxxx">
            </div>
            
            <div class="col-md-6">
              <label for="formGroupExampleInput2" class="form-label"><strong class="fonte-titulo">Raça</strong></label>
              <input type="text" name="Raca" class="form-control fonte-titulo" id="formGroupExampleInput2" placeholder="Raça">
            </div>

            <div class="col-md-6">
                <label for="formGroupExampleInput2" class="form-label"><strong class="fonte-titulo">Idade</strong></label>
                <input type="text" name="Idade" class="form-control fonte-titulo" id="formGroupExampleInput2" placeholder="Idade">
            </div>

            <div class="col-md-6">
              <label for="formGroupExampleInput2" class="form-label"><strong class="fonte-titulo">Tipo</strong></label>
              <input type="text" class="form-control fonte-titulo" id="formGroupExampleInput2" placeholder="Tipo">
            </div>
