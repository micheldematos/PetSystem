...
<body>
    ...
    <main id="background">
        <h2 style="padding-top: 2vh; margin-left: 80vh;"><strong>Consulta Animal</strong></h2>
        <div class="container" style="padding-top: 2vh; margin-left: 3vh;">
            ...
            $so = new SelectOptions();
             foreach ($ConAnimais->getResult() as $valor) {
                 ...
                 echo "<br>";
                 echo "<a href='/ProjetoWeb/public/IntAnimal/$valor->CodAnimal'>Inativar essa porra</a>";
                 echo "<br>";
                 echo "<br>";
             }
            ?>
